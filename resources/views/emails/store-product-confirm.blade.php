            ...
            <table id="Tabela_01" style="margin-bottom: 30px;" width="600" height="auto" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); border-radius: 0 0 5px 5px; background-color: #fff; padding: 50px 50px 50px 50px; text-align: center;">
                        <a href="{{ route('product-confirm-email-url', ['1', $confirm->token]) }}" style="display: inline-block; border-radius: 25px; font-weight: 700; font-size: 14.5px; background-color: rgb(255, 23, 68); color: #fff; width: 230px; height: 43px; line-height: 3;">TEMOS O PRODUTO</a>

                        <a href="{{ route('product-confirm-email-url', ['0', $confirm->token]) }}" style="display: inline-block; border-radius: 25px; font-weight: 700; font-size: 14.5px; margin-left: 20px; background-color: rgb(255, 23, 68); color: #fff; width: 230px; height: 43px; line-height: 3;">NÃO TEMOS O PRODUTO</a>
                    </td>
                </tr>
