            ...
            <table id="Tabela_01" style="margin-bottom: 30px;" width="600" height="auto" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 10px 50px 10px 50px;">
                        <span style="display: block; font-size: 14.5px; color: rgb(100, 100, 100);">Já se passaram 48hs e a loja {{ $reserve->product->store->name }} não respondeu o seu pedido de reserva do produto:</span>
                    </td>
                </tr>

                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 40px 50px 0 50px;">
                        <img src="{{ asset('uploads/' . $reserve->product->store_id . '/products/' . $reserve->product->images->first()->image) }}" style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); float: left; margin-right: 10px; width: 248px; height: 248px; object-fit: cover;" />
                        ...
                        @if ($reserve->product->old_price)
                            <span style="margin-bottom: 10px; display: inline-block; margin-left: 10px; font-size: 14.5px; color: #ff1744;">{{ _discount($reserve->product->price, $reserve->product->old_price) }}% OFF</span>
                        @endif
                        ...
                        <span style="margin-top: 10px; display: block; font-size: 14.5px; color: rgb(150, 150, 150); line-height: 1.286;">{{ $reserve->product->title }}</span>
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 40px 50px 0 50px;">
                        <span style="text-align: center; display: block; font-weight: 700; font-size: 14.5px; color: rgb(255, 23, 68);">PEDIMOS DESCULPAS PELO INCONVENIENTE</span>
                    </td>
                </tr>

                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 10px 50px 0 50px;">
                        <span style="text-align: center; display: block; font-size: 14.5px; color: rgb(150, 150, 150);">Retiramos o produto do site e notificamos a</span>
                    </td>
                </tr>

                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 5px 50px 50px 50px;">
                        <span style="text-align: center; display: block; font-size: 14.5px; color: rgb(150, 150, 150);">loja para que isso não volte a acontecer</span>
                    </td>
                </tr>
