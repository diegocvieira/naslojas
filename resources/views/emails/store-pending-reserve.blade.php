            ...
            <table id="Tabela_01" style="margin-bottom: 30px;" width="600" height="auto" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 10px 50px 10px 50px;">
                        <span style="display: block; font-size: 14.5px; color: rgb(100, 100, 100);">Já se passaram 48hs e a loja {{ $reserve->product->store->name }} não respondeu o pedido de reserva do produto:</span>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 40px 50px 50px 50px;">
                        <span style="display: block; font-size: 14.5px; color: rgb(255, 23, 68);">
                            Por favor certifique-se de conferir seu e-mail ou a sua conta do naslojas
                            para responder as solicitações dos usuários. Se isso for recorrente o
                            sistema removerá todos os produtos da loja {{ $reserve->product->store->name }} do nosso site.
                        </span>
                    </td>
                </tr>
