            ...
            <table id="Tabela_01" style="margin-bottom: 30px;" width="600" height="auto" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); background-color: #fff; padding: 40px 50px 0 50px;">
                        <img src="{{ asset('uploads/' . $reserve->product->store_id . '/products/' . $reserve->product->images->first()->image) }}" style="float: left; margin-right: 10px; width: 248px; height: 248px; box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); object-fit: cover;" />
                        ...
                        <span style="display: block; margin-top: 10px; font-size: 14.5px; color: rgb(150, 150, 150); line-height: 1.286;">{{ $reserve->product->title }}</span>
                ...
                <tr>
                    <td style="box-shadow: 5px 8.66px 9px 1px rgba(100, 100, 100, 0.118); border-radius: 0 0 5px 5px; background-color: #fff; padding: 50px 50px 50px 50px; text-align: center">
                        <a href="{{ route('product-reserve-email-url', ['1', $reserve->token]) }}" style="display: inline-block; border-radius: 25px; font-weight: 700; font-size: 14.5px; background-color: rgb(255, 23, 68); color: #fff; width: 230px; height: 43px; line-height: 3;">RESERVAR POR 24H</a>

                        <a href="{{ route('product-reserve-email-url', ['0', $reserve->token]) }}" style="display: inline-block; border-radius: 25px; margin-left: 20px; font-weight: 700; font-size: 14.5px; background-color: rgb(255, 23, 68); color: #fff; width: 230px; height: 43px; line-height: 3;">NÃO TEMOS O PRODUTO</a>
                    </td>
                </tr>
