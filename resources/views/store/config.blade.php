        ...
        {!! Form::model($user->store, ['method' => 'POST', 'route' => 'set-store-config', 'id' => 'form-store-config', 'files' => true]) !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    ...
                    @if (!isset($navigation) || isset($navigation) && $navigation == 'store-profile')
                        <div class="fields">
                    ...
                    @elseif(isset($navigation) && $navigation == 'address')
                        <div class="fields">
                    ...
                    @elseif (isset($navigation) && $navigation == 'freights')
                    ...
                    @elseif (isset($navigation) && $navigation == 'payment')
                        <div class="fields">
                    ...
                    @elseif (isset($navigation) && $navigation == 'access')
                        <div class="fields">
                            <div class="form-group">
